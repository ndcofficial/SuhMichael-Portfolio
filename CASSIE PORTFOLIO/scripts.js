...
galleryItems.forEach(item => {
    item.addEventListener('click', () => {
        ...
        const imgTitle = item.getAttribute('data-title') || 'Image';
        ...
        const img_element = lightbox.querySelector('.lightbox-image-wrapper img');
        img_element.setAttribute('style', `
            width: 100%;
            height: 100%;
            object-fit: cover;
            border-radius: 0;
        ...
        const infoSection = lightbox.querySelector('.lightbox-info');
        infoSection.setAttribute('style', `
            padding: 25px;
            text-align: center;
        `);
        
        const titleElement = infoSection.querySelector('h3');
        ...
        const descElement = infoSection.querySelector('p');
        descElement.setAttribute('style', `
            color: #B0B0C0;
            font-size: 1rem;
            line-height: 1.6;
        `);
...
whatsappBtn.href = 'https://wa.me/237681131443';
